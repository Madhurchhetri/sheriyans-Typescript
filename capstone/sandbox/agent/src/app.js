 ...
 * @desc read the content of all files requested in the query parameter 'files' and return their content as a JSON object .
 * e.g. /read-files?files=file1.txt,/src/file2.txt
 */
 ...
 * @desc update the content of files specified in the request body. The request body should container a property 'updates' with a JSON Array of objects , each object should have a 'file' property specifying the file path (relative to the working directory) and a 'content' property specifying the new content for the file.
 */
