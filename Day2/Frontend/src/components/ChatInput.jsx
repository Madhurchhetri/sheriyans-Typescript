...
export const ChatInput = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 lg:left-64 right-0 p-6 pb-8 bg-gradient-to-t from-surface via-surface to-transparent pointer-events-none transition-all duration-300">
      <div className="max-w-4xl mx-auto pointer-events-auto relative">
        
        {/* Image Preview Overlay */}
        {selectedFile && (
            <div className="absolute -top-16 left-4 bg-surface-card border border-text-sub/10 shadow-sm rounded-lg p-2 pr-8 flex items-center gap-3">
        ...
        >
          ...
          <div className="flex items-center gap-2 pr-3">
            ...
            <button
               ...
               className={`p-3 rounded-full flex items-center justify-center text-text-sub/70 hover:text-primary transition-colors cursor-pointer ${selectedFile ? 'bg-primary/10 text-primary' : ''}`}
            >
               <Paperclip size={20} />
            </button>
            ...
            <button
              ...
              className={`p-3 rounded-full flex items-center justify-center transition-all duration-150 active:scale-95 ${
